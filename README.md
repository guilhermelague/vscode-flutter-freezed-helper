...
👉 [Flutter Freezed Model Helper on Visual Studio Marketplace](https://marketplace.visualstudio.com/items?itemName=GuilhermeLague.vscode-flutter-freezed-model-helper)
